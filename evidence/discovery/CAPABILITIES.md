...
| RHEL build VM | UNAVAILABLE | Candidate `192.168.1.91:22` gave no response in two bounded TCP probes; no SSH commands were attempted; see `raw/rhel-build-reachability.txt`. |
...
No credential value or private-key content was read into evidence.
